...
function calculateVatInclusivePrice(price) {
  const vatPercent = 20 / 100;
  const totalPriceVatInclusive = price + vatPercent * price;
  return totalPriceVatInclusive;
}

console.log(calculateVatInclusivePrice(80));
